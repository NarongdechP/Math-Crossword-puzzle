...
public class EasyMode extends JPanel {
    ...
    private int countdown60;
    private Timer timer;

    public EasyMode(JFrame1 parentFrame) {
        this.parentFrame = parentFrame;
        setLayout(null);

        countdown60 = 60;

        JLabel countdownLabel = new JLabel("Time : " + countdown60 + "s");
        ...
        timer = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                countdown60--;
                if (countdown60 >= 0) {
                    countdownLabel.setText("Time : " + countdown60 + "s");
                } else {
